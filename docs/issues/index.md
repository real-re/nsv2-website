...
!!! bug "122. 角色在塔`下/上`做向`上/下`移动时再左右移动一次会自动向`下/上`移动"
...
!!! bug "125. 鬼鲛使用3技能时被减速技能攻击，当减速效果解除时原3技能自带的减速效果也会同时消失"
...
!!! success "127. 当角色处于固定的移动状态后，使用速走忍鞋将不会立即变更移动速度"

    历史遗留。

    只有当你变更方向后才会更新移动速度。

!!! success "128. 当角色处于固定的移动状态时，速走忍鞋状态结束后将不会立即变更移动速度"
...
!!! success "96. 长门血量低于30%时成功复活队友自身不死亡"
