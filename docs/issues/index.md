...
!!! warning "目前以下bug影响较大，望周知"
    ...
    截至目前，仍存在极个别特殊情况会导致游戏闪退，主要为引擎缺陷，等待后续逐步修复。
...
!!! bug "133. 在Linux上Logo有时可能不为居中显示"

!!! bug "134. 在maxOS上点击`News`按钮跳转至浏览器后，在点击游戏窗口可能导致重复跳转至浏览器"

    每次跳转到浏览器后都需要手动切换至游戏窗口才不会触发此问题。
...
!!! bug "129. 小李AI不太会释放技能3和奥义2"

!!! bug "130. 千代buff的动画有时在队友阵亡后仍会显示"

    历史遗留。

!!! bug "131. AI长门使用轮回天生不会掉血"
