...
!!! bug "77. 模式选择界面不规则按钮触控会有问题"

    下个版本修复。

!!! bug "78. 当其他角色释放奥义时，可能导致当前角色一直处于使用普通攻击的状态"

!!! bug "79. 角色死后井野的视角可能会有问题"

!!! bug "80. AI水门在技能三状态下移动会鬼畜"
...
!!! bug "82. AI会在距离不够的情况下释放瞬移技能，导致原地释放空技能，不知道是瞬移的机制问题还是AI问题"

    和鹿丸的AI情况相同，具体查看日志https://game.naruto.re/changelog/#v211。

!!! bug "83. 鸣人可以不在不到LV6之前觉醒金鸣"
...
!!! bug "84. 在移动端，按住攻击按钮再进入商店返回，可能导致角色一直处于攻击状态"

!!! bug "85. 查克拉获取数值不准确"

!!! bug "86. 结算界面忍者显示有问题，我方三个，敌方五个，而且顺序和位置不对"

    历史遗留问题，等待后续修复。

!!! bug "87. 角都有时死后有时只会减少心脏数量，不会复活"

!!! bug "88. 水门技能二第二次释放时失效"

    相同问题 #8。

!!! bug "89. 角都技能三在buff特效消失后仍然可以反伤"
