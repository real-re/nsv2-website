...
- 地图
    - [ ] 自定义选择地图
- Operation Online`（预计2023年着手开发）`
    - [ ] 小范围多人在线游戏（OO第四阶段）`仅面向已赞助及杰出贡献玩家使用`
    - [ ] ~~本地联机对战（OO第五阶段）~~`(暂不考虑)`
    - [ ] ~~P2P联机对战（OO第六阶段）~~`(暂不考虑)`
    - [ ] ~~公开多人在线游戏（OO第七阶段）`需要钞$能力`~~`(暂不考虑)`
    - [ ] ？？？（OO终极阶段）


!!! note "关于多人在线"

    这个功能很久之前我就在考虑，有很多方式实现他，但是这并不是一件容易的事情。
    从开发难度来讲，我更偏向多人在线对战，而不是局域网之类的，我可不想什么都自己来写，
    功能强大且稳定的开源联机引擎更加的适合我。

    首先这不是一个靠卖游戏及功能以维持生计的游戏，我是完全依靠极小部分拥有极高热情的玩家赞助下生存的。
    所以他们理应享有`特权`，当然这也包括对游戏做出杰出贡献的人等。
    在困难的时候帮助我是最令我敬畏的人，我一定会给他们应有的答复。

    最后，我想将来可能只会有一个小范围的多人在线游戏，他并不会面向大众开放。

    `（如果哪天我面向公众开放多人在线联机，那就说明我已经不用为生存发愁啦`:partying_face:`）`
