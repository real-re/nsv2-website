...
| 名称 | 说明 |
| --- | --- |
| `S1` 部分倍化之术 | 短时间内中幅提高普通攻击伤害 |
| `S1-2` 家族秘药 | 短时间内提升忍术伤害 |
| `S2` 肉弹战车 | 突进并造成范围忍术伤害 |
| `S3` 超倍化之术 | 变大并造成范围伤害 |
| `O1` 超推手 | 变大并造成范围伤害 |
| `O2` 超倍化之术形态 | 切换为超倍化之术形态 |

> 奥义二「超倍化之术形态」提高移动速度，获得少量防御力（减伤），替换技能1为【家族秘药】，其他技能均替换为超倍化形态的大小。
...
> 本体变为「赤丸」，增加移动速度，全程处于霸体状态。
>
> 当处于骑乘状态时移动速度为正常移速，期间处于霸体状态。

| 名称 | 说明 |
| --- | --- |
| `S1` 人兽分离 | 命令牙单独行动 |
| `S2` 牙通牙 | 赤丸旋转身体对敌人造成范围伤害 |
| `S3` 四脚之术 | 短时间内大幅度提高普通攻击伤害和攻击速度 |
| `O1` 犬冢流·无双牙 | 突进并击飞附近的敌人 |
| `O2` 犬冢流·牙狼牙 | 突进并造成大范围忍术伤害 |

> 人兽分离：分身「牙」没有霸体，且不再跟随本体，自由移动，死亡后回归本体。

> 牙通牙：旋转移动的距离增加1/3。

> 四脚之术：「赤丸」改变形态（变红），攻击力提升，攻击移速增加。
...
| 名称 | 说明 |
| --- | --- |
| `S1` 暴走陀螺 | 高速旋转身体向前突进并拖拽敌人 |
| `S2` 双重爆弹 | 投掷2枚造成击倒效果的地雷 |
| `S3` 我先撤了 | 一段时间内虚化自身并增加移动速度 |
| `O1` 炸弹放置大成功 | 阿飞在敌人脚下放置一颗地雷后回到原点 |
| `O2` 地雷大平原之术 | 在敌人附近快速摆下一圈炸弹，爆炸后对敌人和自己均造成伤害 |

> 我先撤了：当阿飞于闲置、移动和普通攻击状态时将无视所有攻击。
...
| 名称 | 说明 |
| --- | --- |
| `S1` 双重大旋风 | 阿飞快速轮动双臂牵引敌人并造成伤害 |
| `S2` 地雷平原之术 | 钻入地下前进一段距离并沿途设置炸弹 |
| `S3` 我先撤了 | 一段时间内虚化自身并增加移动速度 |
| `O1` 炸弹放置大成功 | 阿飞在敌人脚下放置一颗地雷后回到原点 |
| `O2` 地雷大平原之术 | 在敌人附近快速摆下一圈炸弹，爆炸后对敌人和自己均造成伤害 |
...
## <small>65</small> 野原琳 { id="Rin" }


| 名称 | 说明 |
| --- | --- |
| `S1` 滚木陷阱 | 向前方设置一个滚木陷阱 |
| `S2` 起爆符苦无 | 向前方投掷一枚贴有起爆符的苦无 |
| `S3` 爱心便当 | 丢出爱心便当对敌人造成减速，同时治疗便当周围队友已损失生命值的20% |
| `O1` 医疗忍术 | 为身边生命值最低的友方忍者同时恢复生命值和奥义查克拉 |
| `O2` 三尾暴走 | 爆发三尾查克拉对周围敌人造成范围伤害，随后进入虚弱状态 |

> 医疗忍术：如果回复目标是自己，则只回复血量和奥义一的查克拉。
>   - 特殊效果，对丁次变为回复其生命上限的20%。
> 
> 三尾暴走：对阿飞造成真实伤害（无视虚化效果及无敌）。
