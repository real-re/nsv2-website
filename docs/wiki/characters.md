...
| `S3` 土遁·土矛 | 一段时间内减伤25%, 并返还一半直接攻击造成的伤害给攻击者 |
...
| 名称 | 说明 |
| --- | --- |
| `S1` 外道·轮回天生之术 | 立即复活所有死去的队友【成功复活后若自身血量大于30%时，将血量降低至30%，反之直接阵亡】 |
...
| 名称 | 说明 |
| --- | --- |
| `S1` 傀儡·父与母 | 召唤傀儡父母, 期间傀儡如果在千代身边并处于未攻击状态, 则千代获得霸体及减伤效果 |
| `S2` 傀儡术·操术琥珀 | 操纵傀儡父母造成范围忍术伤害 |
| `S3` 操演·一心同体 | 操纵傀儡父母封印一名敌人的行动 |
| `O1` 禁术·以生转生 | 一段时间内千代婆婆将查克拉分给队友, 并使附近友军进入霸体状态 |
